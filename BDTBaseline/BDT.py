...
if comparison == 0:
    ...
    for fileN in range(1, 101):
        dataFiles.append((DIR + "e-_60_GeV_normal/e-_60_GeV_normal_" + str(
            fileN) + ".h5", ELECTRON))
    for fileN in range(20001, 22001):
        dataFiles.append((
                         DIR + "pi+_60_GeV_normal_025_cut/pi+_60_GeV_normal_" + str(
                             fileN) + ".h5", PI_PLUS))
    ...
    for fileN in range(1, 101):
        dataFiles.append((
                         DIR + "gamma_60_GeV_normal/gamma_60_GeV_normal_" + str(
                             fileN) + ".h5", PHOTON))
    for fileN in range(1, 1001):
        dataFiles.append((DIR + "pi0_60_GeV_normal/pi0_60_GeV_normal_" + str(
            fileN) + ".h5", PI_ZERO))
