from DLKit.DLTools.ModelWrapper import *
...
class Fully3DImageClassification(ModelWrapper):
    ...
    def Build(self):
        ...
        if not self.NoClassificationLayer:
            modelT = Dense(self.N_classes, activation='softmax',
                           kernel_initializer=self.init)(modelT)
...
class MergerRegEModel(ModelWrapper):
    ...
    def Build(self):
        ...
        modelT = Dense(1, activation='tanh', kernel_initializer=self.init)(
            modelT)
