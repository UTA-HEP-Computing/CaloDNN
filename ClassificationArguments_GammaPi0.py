...
parser.add_argument('-C', '--config',default="CaloDNN/ClassificationScanConfig_GammaPi0.py", help="Use specified configuration file.")
...
parser.add_argument('--nocache', action="store_true", help="Do not use cache data to disk for faster read > 1st epoch.")
